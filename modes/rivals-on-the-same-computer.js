...
var p1 = new Player(20, canvas.height/2-60, colors.headColor[0], colors.bodyColor[0], m1);
    p2 = new Player(canvas.width-100, canvas.height/2-60, colors.headColor[0], colors.bodyColor[0], m1);
